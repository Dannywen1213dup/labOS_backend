...
import com.labOS.backend.model.dto.post.PostAddRequest;
import com.labOS.backend.model.dto.post.PostEditRequest;
import com.labOS.backend.model.dto.post.PostQueryRequest;
import com.labOS.backend.model.dto.post.PostUpdateRequest;
...
public class PostController {
    ...
    public BaseResponse<Boolean> deletePost(@RequestBody DeleteRequest deleteRequest, HttpServletRequest request) {
        ...
        // only admin and user themselves can change
    ...
    public BaseResponse<Page<PostVO>> listPostVOByPage(@RequestBody PostQueryRequest postQueryRequest,
        ...
        long current = postQueryRequest.getCurrent();
        long size = postQueryRequest.getPageSize();
        // limited for constant scraper risks
    ...
    /**
     *
     * Retrieves a list of resources created by the current user, paginated
     *
     * @param postQueryRequest
     * @param request
     * @return
    ...
    /**
     * Paginated search (querying from Elasticsearch, wrapper class)
     *
     * @param postQueryRequest
     * @param request
     * @return
    ...
    public BaseResponse<Boolean> editPost(@RequestBody PostEditRequest postEditRequest, HttpServletRequest request) {
        ...
        Post oldPost = postService.getById(id);
        ThrowUtils.throwIf(oldPost == null, ErrorCode.NOT_FOUND_ERROR);
        //Editable only by the user or administrator
